    ...
    <section id="contact" className="py-20 bg-white dark:bg-gray-900 theme-transition">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {contactMethods.map((method, index) => (
            <a
              key={index}
              href={method.action}
              className="group bg-gray-50 dark:bg-gray-800 p-6 rounded-2xl hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 theme-transition"
            >
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="space-y-6">
              {/* Delivery Zones */}
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-2xl theme-transition">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-3">
                  <strong>Free delivery</strong> within these zones for orders over $25. Delivery fee applies for orders under $25.
                </p>
              </div>

              {/* Services */}
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm theme-transition text-center">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Large orders & bulk catering</p>
                </div>
                <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm theme-transition text-center">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Quick & eco-friendly delivery</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 theme-transition">
